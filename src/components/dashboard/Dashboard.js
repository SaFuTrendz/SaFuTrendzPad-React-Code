					...
					<div className="py-6 ">
								...
								<Row>
									<Col xs={24} md={12}>
										...
										<div style={{ padding: '50px' }}>
											<img src={roketImage} className="dashboard-img1" id="roket-image" />
										</div>
									</Col>
									<Col xs={24} md={12}>
							...
							<div className="ant-card-body">
								<div className="lead text-center">
									<div
										...
										style={{ fontSize: '30px', marginBottom: '20px', color: '#ebd15f' }}
									>
						...
						<Row>
							...
							<Col xs={24} md={12}>
								<div className="dashboard2-panel">
									...
									<br />
									<div className="dashboard2-text">✔ Zero Token Charge</div>
									<div className="dashboard2-text">✔ Lowest LaunchPad Fee</div>
									<div className="dashboard2-text">✔ ZSecure With Fast API Request</div>
									<div className="dashboard2-text">✔ Project Support</div>
									<div className="dashboard2-text">✔ Dev Support</div>
									<div className="dashboard2-text">✔ Unique Tools For Projects</div>
								</div>
							</Col>
						</Row>
						<img
						...
						<div className="text-center">
							<div style={{ marginTop: '50px' }}>
								<iframe width="90%" height="300" src="https://www.youtube.com/embed/17QRFlml4pA" />
