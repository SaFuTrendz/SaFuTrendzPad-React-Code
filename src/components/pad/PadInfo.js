...
import { Button, Input, Radio, RadioGroup, List, Col, Row, FlexboxGrid } from 'rsuite';
			...
			axios
				...
				.then(async (res) => {
					...
					presaleContract.methods.userDeposit().send(parameter).then(() => {
						...
						axios
							.post(`/api/alarm/addSaleToken`, data2)
							.then((res) => console.log('token add successfully'));
														...
														<div className="padinfo-table">
															<Row>
																<Col
																	md={12}
																	xs={12}
																	className="has-text-left launch-tr"
																>
																	Presale Status
																</Col>
																<Col
															...
															<Row>
																<Col md={8} xs={8} className="has-text-left launch-tr">
																	Sold Tokens
																</Col>
																<Col
																	md={16}
															...
															>
																<ProgressBar
																	...
																	customLabel={
																		(saleCount / Number(softCap) * 100).toFixed(0) +
																		'%'
																	}
																	height="15px"
																/>
