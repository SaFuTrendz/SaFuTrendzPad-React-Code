...
class FairLaunchPad3 extends Component {
	constructor(props) {
		super(props);
	...
	validateField(fieldName, value) {
		...
		switch (fieldName) {
			case 'logoUrl':
				logoUrlValid = !isEmpty(value) ? true : false;
				...
				break;
			case 'website':
				websiteValid = !isEmpty(value) ? true : false;
				logoUrlValid = value.match(/^((http|https):\/\/)/);
...
export default connect(mapStateToProps, { setReduxValue1 })(withRouter(FairLaunchPad3));
